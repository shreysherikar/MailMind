...
class Task(BaseModel):
    ...
    title: str = Field(..., max_length=100, description="Brief task title")
    ...
    source_email: SourceEmail = Field(..., description="Reference to source email")
...
class TaskCompleteResponse(BaseModel):
    ...
    archive_source_email: bool = Field(
        ..., 
        description="True if all tasks from source email are completed"
    )
    source_email_id: str
